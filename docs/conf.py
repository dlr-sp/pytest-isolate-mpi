...
version = pytest_isolate_mpi.__version__
# The full version, including alpha/beta/rc tags.
release = pytest_isolate_mpi.__version__
...
latex_documents = [
    (master_doc, 'pytest_isolate_mpi.tex',
     'pytest-isolate-mpi Documentation',
     'German Aerospace Center (DLR e.V.)', 'manual'),
]
