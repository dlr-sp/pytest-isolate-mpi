...
if __name__ == '__main__':
    ...
    # try:
    #     item = pickle.load(os.open(sys.argv[2], 'r'))
    # except Exception as err:
    #     print(f'failed to deserialize test object from {sys.argv[2]}: {err}')
    ...
    try:
        try:
            ...
            # test.run()
            print(f'MPI rank[{comm.rank}] running test {sys.argv[1]}')
